...
public class CalculateTwoSetWithSuperTie {
	...
	public static Score calculate(Score score, int whichplayer) {
		...
		if (set1 == 6 && set2 == 6) {
			score.setGameMode(Score.GAME_MODE.SUPER_TIEBREAK);
			score = SuperTieMath.calculate(score, whichplayer);
		}
//		if (score.getPl1_set_score() == 1 && score.getPl2_set_score() == 1) {
//			score.setGameMode(Score.GAME_MODE.SUPER_TIEBREAK);
//			score = SuperTieMath.calculate(score, whichplayer);
//		}
